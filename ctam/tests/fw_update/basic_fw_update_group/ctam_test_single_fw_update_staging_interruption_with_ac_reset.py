...
:Usage 1:		python ctam.py -T F62
:Usage 2:		python ctam.py -T "CTAM Test Single FW update staging interruption with AC reset"
...
from tests.fw_update.basic_fw_update_group.basic_fw_update_group import BasicFWUpdateTestGroup
