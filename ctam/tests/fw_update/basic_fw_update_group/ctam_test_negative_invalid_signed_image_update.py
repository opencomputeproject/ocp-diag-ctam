...
:Test Name:		CTAM Test Negative Invalid Signed Image Update
:Test ID:		F22
...
:Usage 1:		python ctam.py -T F2
:Usage 2:		python ctam.py -T "CTAM Test Negative Invalid Signed Image Update"
...
from tests.fw_update.basic_fw_update_group.basic_fw_update_group import (
    BasicFWUpdateTestGroup,
)
...
class CTAMTestNegativeInvalidSignedImageUpdate(TestCase):
    ...
    test_id: List[str] = ["F22"]
    score_weight: int = 10
    tags: List[str] = []
    # exclude_tags: List[str] = []

    def __init__(self, group: BasicFWUpdateTestGroup):
        """
        _summary_
        """
        super().__init__()
