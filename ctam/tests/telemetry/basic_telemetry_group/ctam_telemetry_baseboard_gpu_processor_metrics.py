...
:Usage 1:		python ctam.py -T T11
:Usage 2:		python ctam.py -T "CTAM Test Telemetry Baseboard GPU Processor Metrics"
...
class CTAMTestTelemetryBaseboardGPUProcessorMetrics(TestCase):
    ...
    def run(self) -> TestResult:
        ...
        """
        # data = self.group.telemetry_ifc.ctam_gpu_thermal_id()
        # print(data)
        result = True
