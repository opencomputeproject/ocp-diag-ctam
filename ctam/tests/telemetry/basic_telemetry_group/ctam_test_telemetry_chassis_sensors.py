...
:Test Name:		CTAM Test Telemetry Chassis Sensors Metrics
:Test ID:		T14
...
import json
class CTAMTestTelemetryChassisSensorsMetrics(TestCase):
    
    test_name: str = "CTAM Test Telemetry Chassis Sensors Metrics"
    test_id: str = "T14"
    score_weight: int = 10
    tags: List[str] = []
    ...
    def run(self) -> TestResult:
        ...
        with step1.scope():
            if self.group.telemetry_ifc.ctam_chassis_sensors_metrics():
