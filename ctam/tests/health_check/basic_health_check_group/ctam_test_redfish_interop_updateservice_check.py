...
:Test Name:		CTAM Test Redfish Interop Validator UpdateService
:Test ID:		H1
:Group Name:	health_check
:Score Weight:	10

:Description:	This test case validates the UpdateService using the Redfish Interop Validator (RIV). It ensures that the values of the UpdateService are present and correct.

                PASS Criteria:
                1. The UpdateService is validated successfully without errors.

                FAIL Criteria:
                1. The UpdateService validation fails or returns errors.

:Usage 1:		python ctam.py -w ..\workspace -t H1
:Usage 2:		python ctam.py -w ..\workspace -t "CTAM Test Redfish Interop Validator UpdateService"
...
class CTAMTestRedfishInteropValidatorUpdateService(TestCase):
    """
    Verify values of UpdateService are present

    :param TestCase: super class for all test cases
    :type TestCase:
    """

    test_name: str = "CTAM Test Redfish Interop Validator UpdateService"
    test_id: str = "H1"
    score_weight: int = 10
